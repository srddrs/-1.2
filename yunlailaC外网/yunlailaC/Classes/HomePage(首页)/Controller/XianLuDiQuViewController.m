...
#import "XianLuFuWuDianViewController.h"
@interface XianLuDiQuViewController ()<UICollectionViewDataSource,UICollectionViewDelegate,UICollectionViewDelegateFlowLayout,UITextFieldDelegate>
{
...
@implementation XianLuDiQuViewController
@synthesize sheng;
@synthesize shi;
...
//    [_collectionView reloadData];
    ...
    if (fuwudian.count>0)
    {
        XianLuFuWuDianViewController *vc =[[XianLuFuWuDianViewController alloc] init];
