...
- (instancetype)initWithFrame:(CGRect)frame
{
    if (self=[super initWithFrame:frame]) {
        ...
        [plusBtn setBackgroundImage:[UIImage imageNamed:@"zhuye_fahuo"] forState:UIControlStateNormal];
        [plusBtn setBackgroundImage:[UIImage imageNamed:@"zhuye_fahuo"] forState:UIControlStateHighlighted];
...
//    [label sizeToFit];
//    label.textColor = titleViewColor;
