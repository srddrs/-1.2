...
@interface DaoDaDiQuViewController ()<UICollectionViewDataSource,UICollectionViewDelegate,UICollectionViewDelegateFlowLayout,UITextFieldDelegate>
{
...
@implementation DaoDaDiQuViewController
@synthesize sheng;
@synthesize shi;
...
-(void)buttonClick:(UIButton *)sender
{
    ...
    if (fuwudian.count>0)
    {
        DaoDaFuWuDianViewController *vc =[[DaoDaFuWuDianViewController alloc] init];
    ...
    {
        NSString *text = [NSString stringWithFormat:@"%@%@%@",[sheng objectForKey:@"receipt_name"],[shi objectForKey:@"receipt_name"],[diqu objectForKey:@"receipt_name"]];
//        NSString *text = [NSString stringWithFormat:@"%@",[diqu objectForKey:@"receipt_name"]];
        NSDictionary *info = @{
                               @"text" :text ,
                               @"receipt_region_id" : [diqu objectForKey:@"receipt_region_id"],
                               };
