...
//                                     @"hex_client_member_queryAccountInfoFunction",@"funcId",
                                     nil];
...
- (void)initView
{
    _tableView = [[UITableView alloc] initWithFrame:CGRectMake(0, 0, [UIScreen mainScreen].bounds.size.width, [UIScreen mainScreen].bounds.size.height - TabbarHeight*APP_DELEGATE().autoSizeScaleY - statusViewHeight*APP_DELEGATE().autoSizeScaleY)];
