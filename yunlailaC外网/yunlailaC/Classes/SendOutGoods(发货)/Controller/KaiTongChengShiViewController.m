...
@interface KaiTongChengShiViewController ()<UICollectionViewDataSource,UICollectionViewDelegate,UICollectionViewDelegateFlowLayout,UITextFieldDelegate>
{
...
@implementation KaiTongChengShiViewController
@synthesize sheng;
...
-(void)buttonClick:(UIButton *)sender
{
    ...
    if (diqus.count>0)
    {
        KaiTongDiQuViewController *vc =[[KaiTongDiQuViewController alloc] init];
    ...
    {
//        NSString *text = [NSString stringWithFormat:@"%@%@",[sheng objectForKey:@"region_name"],[shi objectForKey:@"region_name"]];
         NSString *text = [NSString stringWithFormat:@"%@",[shi objectForKey:@"region_name"]];
        NSDictionary *info = @{
                               @"text" :text ,
                               @"region_id" : [shi objectForKey:@"region_id"],
                               };
