...
@interface XianLuShengViewController ()<UICollectionViewDataSource,UICollectionViewDelegate,UICollectionViewDelegateFlowLayout,UITextFieldDelegate>
{
...
@implementation XianLuShengViewController
...
//    [_collectionView reloadData];
    ...
    if (shis.count>0)
    {
        XianLuShiViewController *vc = [[XianLuShiViewController alloc] init];
