...
#import "XianLuShiViewController.h"
#import "XianLuDiQuViewController.h"
@interface XianLuShiViewController ()<UICollectionViewDataSource,UICollectionViewDelegate,UICollectionViewDelegateFlowLayout,UITextFieldDelegate>
{
...
@implementation XianLuShiViewController
@synthesize sheng;
...
//    [_collectionView reloadData];
    ...
    if (diqus.count>0)
    {
        XianLuDiQuViewController *vc =[[XianLuDiQuViewController alloc] init];
