...
- (void) initView
{
    ...
    _tableView = [[UITableView alloc] initWithFrame:CGRectMake(0, 31, [UIScreen mainScreen].bounds.size.width, [UIScreen mainScreen].bounds.size.height - TabbarHeight - statusViewHeight-31)];
...
//    [dateFormatter setDateFormat:@"yyyy-MM-dd HH:mm:ss"];
    ...
    [UIView animateWithDuration:0.3 animations:^{
        ...
        _tableView.frame = CGRectMake(0, 61, [UIScreen mainScreen].bounds.size.width, [UIScreen mainScreen].bounds.size.height - TabbarHeight - statusViewHeight-61);
    }];
}
...
- (void)actionSheetPickerViewWillCancel:(IQActionSheetPickerView *)pickerView
{
    ...
    if (startLabel.text.length==0&&endLabel.text.length==0)
    {
        [UIView animateWithDuration:0.3 animations:^{
            ...
            _tableView.frame = CGRectMake(0, 31, [UIScreen mainScreen].bounds.size.width, [UIScreen mainScreen].bounds.size.height - TabbarHeight - statusViewHeight-31);
        }];
    }
}
