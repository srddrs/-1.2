//
//  KaiTongShengShiViewController.m
//  yunlailaC
//
...
#import "KaiTongChengShiViewController.h"
@interface KaiTongShengShiViewController ()<UICollectionViewDataSource,UICollectionViewDelegate,UICollectionViewDelegateFlowLayout,UITextFieldDelegate>
{
...
@implementation KaiTongShengShiViewController
...
- (void) initView
{
    ...
    _collectionView = [[UICollectionView alloc] initWithFrame:CGRectMake(15, 44, [UIScreen mainScreen].bounds.size.width -30 , [UIScreen mainScreen].bounds.size.height - TabbarHeight - statusViewHeight - 44) collectionViewLayout:flowLayout];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [button1 setTitle:[NSString stringWithFormat:@"%@",[sheng objectForKey:@"region_name"]] forState:UIControlStateNormal];
    [button1 setTitle:[NSString stringWithFormat:@"%@",[sheng objectForKey:@"region_name"]] forState:UIControlStateHighlighted];
    [button1 setTitle:[NSString stringWithFormat:@"%@",[sheng objectForKey:@"region_name"]] forState:UIControlStateSelected];
...
-(void)buttonClick:(UIButton *)sender
{
    ...
    NSLog(@"点击了：省%@",[sheng objectForKey:@"region_name"]);
    NSArray *shis = [sheng objectForKey:@"child"];
    if (shis.count>0)
    {
        KaiTongChengShiViewController *vc = [[KaiTongChengShiViewController alloc] init];
    ...
    {
        NSDictionary *info = @{
                            @"text" :[sheng objectForKey:@"region_name"] ,
                            @"region_id" : [sheng objectForKey:@"region_id"],
                            };
