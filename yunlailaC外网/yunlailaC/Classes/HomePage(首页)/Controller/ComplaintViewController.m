...
@interface ComplaintViewController ()<WJSegmentMenuDelegate,UITableViewDataSource,UITableViewDelegate,SWTableViewCellDelegate>
{
...
- (void)requestServer
{
    ...
    NSMutableDictionary *paramDic = [[NSMutableDictionary alloc] initWithObjectsAndKeys:
                                     @"hex_complaint_queryMemberComplaint",@"funcId",
...
//    cell.rightUtilityButtons = [self rightButtons];
    ...
    icon.image = [UIImage imageNamed:@"toushu"];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [UIAlertView showAlert:@"投诉进展页面web制作中" cancelButton:@"确定"];
}
