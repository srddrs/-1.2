...
@interface WaybillsViewController ()<UITableViewDataSource,UITableViewDelegate,SWTableViewCellDelegate>
{
...
@implementation WaybillsViewController
@synthesize order;//上级页面传参
...
- (void)requestServer
{
    ...
    NSMutableDictionary *paramDic = [[NSMutableDictionary alloc] initWithObjectsAndKeys:
                                     @"hex_client_queryWayBillByIndentId",@"funcId",
...
//    cell.accessoryType = UITableViewCellAccessoryDisclosureIndicator;
    ...
    UIButton *genzhongBtn = [[UIButton alloc] initWithFrame: CGRectMake(0*APP_DELEGATE().autoSizeScaleX, 150,300*APP_DELEGATE().autoSizeScaleX, 45)];
