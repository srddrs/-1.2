//
//  KaiTongFuWuDianViewController.m
//  yunlailaC
//
...
@interface KaiTongFuWuDianViewController ()<UICollectionViewDataSource,UICollectionViewDelegate,UICollectionViewDelegateFlowLayout,UITextFieldDelegate>
{
...
@implementation KaiTongFuWuDianViewController
@synthesize sheng;
@synthesize shi;
@synthesize diqu;
...
//    NSString *text = [NSString stringWithFormat:@"%@%@%@%@",[sheng objectForKey:@"region_name"],[shi objectForKey:@"region_name"],[diqu objectForKey:@"region_name"],[fuwudian objectForKey:@"region_name"]];
     NSString *text = [NSString stringWithFormat:@"%@",[fuwudian objectForKey:@"region_name"]];
    NSDictionary *info = @{
                           @"text" :text ,
                           @"region_id" : [fuwudian objectForKey:@"region_id"],
                           };
